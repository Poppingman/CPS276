...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'salramamneh';//this will be your WCC username
      $dbUsr = 'salramamneh';//this will be your WCC username
      $dbPass = 'MeKeEoJgU6TScxm';//this will be the password found in the video.
